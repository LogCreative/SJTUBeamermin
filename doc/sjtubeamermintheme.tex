...
\textsf{SJTUBeamer} \fbox{\textsc{min}} 将于 2022 年 1 月 1 日起正式停止服务，届时该存储库将会被标记为存档状态。

SJTUG 已推出统一化的 \href{https://github.com/sjtug/SJTUBeamer}{SJTUBeamer 模板}，\textsf{SJTUBeamer} \fbox{\textsc{min}} 已于 2021 年 9 月 3 日完成了相关\href{https://github.com/sjtug/SJTUBeamer/issues/25}{代码合并}，多轮的版本迭代已经让其拥有更为灵活的个性化方案。如果希望继续获得关于该模板的相关支持可迁移至 SJTUBeamer，并使用 \texttt{min} 和 \texttt{default} 参数。

如您在迁移至 SJTUBeamer 的过程中遇到任何问题，可以在本存储库尚未存档前直接向该存储库提出 \href{https://github.com/LogCreative/SJTUBeamermin/issues}{issue}，或者联系技术支持人员：
\begin{quote}
邮件：\href{malito:logcreative@outlook.com}{\ttfamily logcreative@outlook.com}
\end{quote}
\noindent Log Creative\\
2021 年 11 月 5 日
...
The Current Maintainer of this work is Log Creative. And it will no longer be maintained after Jan 1st, 2022.
